    ...
    public static class CardData
    {
        ...
        public static List<CardInfo> GetCardsForCity(string cityName)
        {
            return cityName switch
            {
                ...
                {
                    new CardInfo {
                        Title = CardDESC.Title["台南"][0],
                        Description = CardDESC.Desc["台南"][0],
                        MoneyChange = -500,
                        EcoChange = +9,
                        SocialChange = +2,
                        ColorTag = "green"
                    ...
                    new CardInfo {
                        ...
                        Description = CardDESC.Desc["台南"][1],
                        MoneyChange = -200,
                        EcoChange = +3,
                        SocialChange = +8,
                        ColorTag = "yellow"
                    ...
                    new CardInfo {
                        ...
                        Description = CardDESC.Desc["台南"][2],
                        MoneyChange = -300,
                        EcoChange = +7,
                        SocialChange = +1,
                        ColorTag = "red"
                    ...
                    new CardInfo {
                        ...
                        Description = CardDESC.Desc["台南"][3],
                        MoneyChange = -200,
                        EcoChange = +3,
                        SocialChange = +8,
                        ColorTag = "yellow"
                    ...
                    new CardInfo {
                        ...
                        Description = CardDESC.Desc["台南"][4],
                        MoneyChange = -300,
                        EcoChange = +7,
                        SocialChange = +1,
                        ColorTag = "red"
                    ...
                    new CardInfo {
                        ...
                        Description = CardDESC.Desc["台南"][5],
                        MoneyChange = -200,
                        EcoChange = +3,
                        SocialChange = +8,
                        ColorTag = "yellow"
                    ...
                    new CardInfo {
                        ...
                        Description = CardDESC.Desc["台南"][6],
                        MoneyChange = -300,
                        EcoChange = +7,
                        SocialChange = +1,
                        ColorTag = "red"
                    ...
                    new CardInfo {
                        ...
                        Description = CardDESC.Desc["台南"][7],
                        MoneyChange = +150,
                        EcoChange = +4,
                        SocialChange = +6,
                        ColorTag = "yellow"
                    ...
                    new CardInfo {
                        Title = CardDESC.Title["台南"][8],
                        Description = CardDESC.Desc["台南"][8],
                        MoneyChange = -200,
                        EcoChange = +3,
                        SocialChange = +8,
                        ColorTag = "yellow"
                    ...
                    new CardInfo {
                        Title = CardDESC.Title["台南"][9],
                        Description = CardDESC.Desc["台南"][9],
                        MoneyChange = -300,
                        EcoChange = +7,
                        SocialChange = +1,
                        ColorTag = "red"
